...
barra_jovem_propx
ggsave("barra_jovem_prop_APT.png", barra_jovem_propx, width = 10, height = 6, units = "in")
...
barra_jovem_propx
ggsave("barra_jovem_pop_APT.png", barra_jovem_propx, width = 10, height = 6, units = "in")
...
ggsave("barra_sex_APT.png", barra_sex, width = 14, height = 6, units = "in")
