...
gsub("^.*?-","_",pop_idaderaca_2010$localidade)
gsub("\\-*","",pop_idaderaca_2010$localidade)

gsub("Recife|(PE)","", pop_idaderaca_2010$localidade)



pop_idaderaca_2010$localidade <- gsub("Recife|(PE)","", pop_idaderaca_2010$localidade)
pop_idaderaca_2010$localidade
